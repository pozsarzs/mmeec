...
begin
  ...
  try
    ...
    for b:=0 to 9 do
      hheaterdis[0]:=strtoint(iif.ReadString(H,'heater_disable_0'+inttostr(b),'0'));
    for b:=10 to 23 do
      hheaterdis[0]:=strtoint(iif.ReadString(H,'heater_disable_'+inttostr(b),'0'));
    ...
    for b:=0 to 9 do
      hventdis[0]:=strtoint(iif.ReadString(H,'vent_disable_0'+inttostr(b),'0'));
    for b:=10 to 23 do
      hventdis[0]:=strtoint(iif.ReadString(H,'vent_disable_'+inttostr(b),'0'));
    for b:=0 to 9 do
      hventdislowtemp[0]:=strtoint(iif.ReadString(H,'vent_disablelowtemp_0'+inttostr(b),'0'));
    for b:=10 to 23 do
      hventdislowtemp[0]:=strtoint(iif.ReadString(H,'vent_disablelowtemp_'+inttostr(b),'0'));
    ...
    for b:=0 to 9 do
      mheaterdis[0]:=strtoint(iif.ReadString(H,'heater_disable_0'+inttostr(b),'0'));
    for b:=10 to 23 do
      mheaterdis[0]:=strtoint(iif.ReadString(H,'heater_disable_'+inttostr(b),'0'));
    ...
    for b:=0 to 9 do
      mventdis[0]:=strtoint(iif.ReadString(H,'vent_disable_0'+inttostr(b),'0'));
    for b:=10 to 23 do
      mventdis[0]:=strtoint(iif.ReadString(H,'vent_disable_'+inttostr(b),'0'));
    for b:=0 to 9 do
      mventdislowtemp[0]:=strtoint(iif.ReadString(H,'vent_disablelowtemp_0'+inttostr(b),'0'));
    for b:=10 to 23 do
      mventdislowtemp[0]:=strtoint(iif.ReadString(H,'vent_disablelowtemp_'+inttostr(b),'0'));
